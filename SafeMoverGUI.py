...
class Window(QWidget):
    ...
    def algoSelector(self):
        ...
        self.algoCombo.move(110, 20)
        self.algoCombo.resize(140, 30)

    def SourceDestUI(self):
        self.sourceLabel = QLabel('Source', self)
        self.sourceLabel.move(20, 60)
        ...
        self.sourceInput.move(110, 60)
        self.sourceInput.resize(140, 30)
        ...
        self.destInput.move(110, 100)
        self.destInput.resize(140, 30)
    ...
    def logsUI(self):
        ...
        self.logsInput.move(110, 140)
        self.logsInput.resize(140, 30)
        ...
        self.log_text_box.move(340, 20)
        self.log_text_box.resize(280, 380)

    def progressBar(self):
        self.pBar = QProgressBar(self)
        self.pBar.setGeometry(20, 330, 230, 20)
        ...
        self.ETA.move(260, 330)
        self.ETA.resize(120, 20)
        self.ETA.setText('')

        self.progressText = QLabel(self)
        self.progressText.move(20, 300)
        self.progressText.resize(560, 30)
        self.progressText.setText('')

    def msgUI(self):
        self.msgLabel = QLabel(self)
        self.msgLabel.move(20, 300)
        self.msgLabel.resize(280,30)
